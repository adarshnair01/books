...
![When your generalist LLM tries to be a specialist... you might need a second opinion. Or a real surgeon.](/images/gen_ai/Chapter_7_Fine-Tuning__LoRA/diagram_1_when_your_generalist_llm_tries_to_be_a_s.png)
...
![From generalist gourmet to Neapolitan ninja: Fine-tuning a chef for specialized tasks.](/images/gen_ai/Chapter_7_Fine-Tuning__LoRA/diagram_2_from_generalist_gourmet_to_neapolitan_ni.png)
...
![Full fine-tuning: A slight overkill for a minor renovation.](/images/gen_ai/Chapter_7_Fine-Tuning__LoRA/diagram_3_full_fine_tuning__a_slight_overkill_for_.png)
...
![PEFT vs. Full Fine-Tuning: Precision touch-ups beat total demolition every time.](/images/gen_ai/Chapter_7_Fine-Tuning__LoRA/diagram_4_peft_vs__full_fine_tuning__precision_tou.png)
...
![Choosing your PEFT flavor: What kind of specialized boost does your LLM need today?](/images/gen_ai/Chapter_7_Fine-Tuning__LoRA/diagram_5_choosing_your_peft_flavor__what_kind_of_.png)
...
![LoRA in action: Precision adjustments without disturbing the main gray matter.](/images/gen_ai/Chapter_7_Fine-Tuning__LoRA/diagram_6_lora_in_action__precision_adjustments_wi.png)
...
![The magic of LoRA: Approximating a complex change (the unicorn) with simple, low-rank brushstrokes.](/images/gen_ai/Chapter_7_Fine-Tuning__LoRA/diagram_7_the_magic_of_lora__approximating_a_compl.png)
...
![LoRA's parallel path: The original W stays frozen, while tiny A and B matrices learn the task-specific 'delta' and add it to the original output.](/images/gen_ai/Chapter_7_Fine-Tuning__LoRA/diagram_8_lora_s_parallel_path__the_original_w_sta.png)
...
3.  **Train Multiple Adapters on a Single Base Model (The Multi-Tasking Maestro!)**:
    ...
    *   ![One LLM, many specialties: LoRA adapters let your base model wear countless hats.](/images/gen_ai/Chapter_7_Fine-Tuning__LoRA/diagram_9_one_llm__many_specialties__lora_adapters.png)
...
![LoRA's target practice: Zeroing in on the crucial Q and V projection matrices.](/images/gen_ai/Chapter_7_Fine-Tuning__LoRA/diagram_10_lora_s_target_practice__zeroing_in_on_th.png)
...
![Finding your `r`: Too low, and you miss the point. Too high, and you might overdo it. Just right, and you capture the essence efficiently.](/images/gen_ai/Chapter_7_Fine-Tuning__LoRA/diagram_11_finding_your__r___too_low__and_you_miss_.png)
...
![One brain, many expert hats: LoRA lets your LLM master diverse, niche domains.](/images/gen_ai/Chapter_7_Fine-Tuning__LoRA/diagram_12_one_brain__many_expert_hats__lora_lets_y.png)
...
![LoRA is great for tailoring, but some tasks require a complete redesign, not just alterations.](/images/gen_ai/Chapter_7_Fine-Tuning__LoRA/diagram_13_lora_is_great_for_tailoring__but_some_ta.png)
...
![QLoRA: Shrinking the base model so even giant brains fit on your GPU, then adding LoRA's magic.](/images/gen_ai/Chapter_7_Fine-Tuning__LoRA/diagram_14_qlora__shrinking_the_base_model_so_even_.png)
...
![From generalist apprentice to a team of specialized masters, all thanks to LoRA's focused training.](/images/gen_ai/Chapter_7_Fine-Tuning__LoRA/diagram_15_from_generalist_apprentice_to_a_team_of_.png)
